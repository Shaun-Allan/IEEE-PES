...
import './AdminHeader.css'; // Ensure you have this CSS file
import { Button } from "@nextui-org/react";
import AdminMobileHeader from './AdminMobileHeader'; // Import the mobile header component
  ...
  return isMobile? (
    ...
    <header className="navbar shadow-lg h-20 flex items-center justify-between px-8 bg-white border-b border-gray-200">
      ...
      <nav className="hidden sm:flex gap-14">
        ...
        <NavLink to="/admin/events" className="nav-link" activeClassName="active">
          Events
        </NavLink>
        <NavLink to="/admin/team" className="nav-link" activeClassName="active">
          Team
        </NavLink>
      </nav>
